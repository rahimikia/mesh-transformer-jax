...
def process_args(
    ...
    **kwargs,
    ...
    return  ticker_name, year, np_dtype, torch_dtype


argsX = vars(parser.parse_args())
ticker, year, np_dtype, torch_dtype = process_args(**argsX)
...
if __name__ == "__main__":
    ...
    ticker_name, year, np_dtype, torch_dtype = process_args(**args)
